...
for i in ${arr[@]}; do
	ssh -oStrictHostKeyChecking=no -R 172.0.0.1:3457:127.0.0.1:3457 -L 127.0.0.1:$port:127.0.0.1:$port $i "/home/keefedf/dtorban/project/VirtualLab/bin/msi-setup-worker.sh $port" & 
	port=$((port+1))
done
